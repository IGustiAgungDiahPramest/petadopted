...
class FormcsScreen extends StatefulWidget {
  const FormcsScreen({Key? key}) : super(key: key);

  @override
  _FormcsScreenState createState() => _FormcsScreenState();
}

class _FormcsScreenState extends State<FormcsScreen> {
  ...
  Future<void> _postDataWithImage(BuildContext context) async {
    ...
    var request = MultipartRequest('POST', Uri.parse(Endpoints.customer));
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Form Problem'),
        backgroundColor: const Color.fromARGB(255, 2, 159, 238),
      ),
      body: Padding(
